...
basic_dir <- "/nas/longleaf/home/adaigle/SFS/"
...
figure2 <- ggplot(plotting_df_0909599, aes(x = entry_number, y = prop, fill = factor(SFS))) +
  geom_bar(stat = "identity", position = "dodge", colour = "black", aes(group = interaction(SFS, selfing))) +
...
ggsave("/nas/longleaf/home/adaigle/DFESelfing/figures_for_publication/figure2.svg", plot = figure2, width = 8.5, height = 7, dpi = 600)
...
domh025_dir <- "/nas/longleaf/home/adaigle/work/johri_elegans/sim_outputs/dom/hdel_0_25/SFS/"
...
#plotting_df_h025 <- plotting_df %>% filter(selfing != 80 & selfing != 50)
...
domh025_unlinked_dir <- "/nas/longleaf/home/adaigle/work/johri_elegans/sim_outputs/nolinkage_h025/fail_final_50k_outputs/SFS_for_plotting/"
selfings_h025 <- c(0,50,99)
...
domh05_unlinked_dir <- "/nas/longleaf/home/adaigle/work/johri_elegans/sim_outputs/nolinkage/final_50k_outputs/SFS_for_plotting/"
...
#plotting_df_h05 <- plotting_df %>% filter(selfing != 80 & selfing != 50)
