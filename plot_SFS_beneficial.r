...
#
#barplot(tapply(unlist(eqm_selfing99_DFE1_sel_100_m2,m4[1, 3:102]), rep(1:10, each = 10), sum))
...
#    means = apply(eqm_selfing50_DFE2_sel_100_m2,m4[3:101], 2, mean),
#    sd = apply(eqm_selfing50_DFE2_sel_100_m2,m4[3:101], 2, sd),
#    entry_number = 1:length(means),
#    SFS = "selected"
#    )
#
...
#}))
#selected_10 <- t(apply(eqm_selfing50_DFE2_sel_100_m2,m4, 1, function(x) {
#  tapply(as.numeric(x[3:102]), rep(1:10, each = 10), sum)
#}))
#
