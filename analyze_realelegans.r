...
dfealpha_dir <- "/nas/longleaf/home/adaigle/work/johri_elegans/sim_outputs/real_celegans/dfealpha/"
dfealpha_output_dirs <- paste0(dfealpha_dir, dir(dfealpha_dir, pattern="realelegans_selected", include.dirs = T))
...
grapes_dir <- "/nas/longleaf/home/adaigle/work/johri_elegans/sim_outputs/real_celegans/grapes"
output_dirs <- grapes_dir
