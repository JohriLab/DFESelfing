...
Nem2 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_uneven_1_plot/Nem2.csv")
Nem1 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_uneven_1_plot/Nem1.csv")
Nem01 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_uneven_1_plot/Nem01.csv")
Nem05 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_uneven_1_plot/Nem05.csv")
...
sfigure14 <- ggarrange(Nem2_plt, Nem1_plt, Nem05_plt, Nem01_plt,
                    labels = c("A", "B", "C", "D"),
                    font.label = list(size = 24, color = "black", face = "bold", family = NULL),
                    ncol = 2, nrow = 2,
                    common.legend = T, legend = "bottom")
...
ggsave("/nas/longleaf/home/adaigle/DFESelfing/figures_for_publication/sfigure14.svg", plot = sfigure14, width = 8.5, height = 10, dpi = 600)
