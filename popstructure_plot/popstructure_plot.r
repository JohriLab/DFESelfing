...
Nem2 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_plot/Nem2.csv")
Nem1 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_plot/Nem1.csv")
Nem01 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_plot/Nem01.csv")
Nem05 <- read.csv("/nas/longleaf/home/adaigle/DFESelfing/popstructure_plot/Nem05.csv")
...
sfigure13 <- ggarrange(Nem2_plt, Nem1_plt, Nem05_plt,
                    labels = c("A", "B", "C"),
                    font.label = list(size = 24, color = "black", face = "bold", family = NULL),
                    ncol = 2, nrow = 2,
                    common.legend = T, legend = "bottom")
...
ggsave("/nas/longleaf/home/adaigle/DFESelfing/figures_for_publication/sfigure13.svg", plot = sfigure13, width = 8.5, height = 10, dpi = 600)
