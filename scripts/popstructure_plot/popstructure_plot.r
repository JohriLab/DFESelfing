...
ggsave(paste0(figures_dir, "figure8.svg"), plot = Nem01_plt, width = 8.5, height = 8.5, dpi = 600)
ggsave(paste0(figures_dir, "sfigure13.svg"), plot = sfigure13, width = 8.5, height = 10, dpi = 600)
