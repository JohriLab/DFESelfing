...
results_dir <- paste0(sim_outputs_dir, "scaling_q50/")
source(paste0(base_dir, "scripts/calculate_pi_q10.r"))

figures_dir <- paste0(base_dir, "figures_for_publication/")
dfe_results_dir <- paste0(sim_outputs_dir, "scaling_q50/dfe_results/")
...
combo_plot_scale <- combo_plot_with_Badjusted %>% mutate(scale=50)
B_value_table_scale <- B_value_table %>% mutate(scale=50)
write.csv(combo_plot_scale, file=paste0(base_dir, "scripts/scaling/q50.csv"))
write.csv(B_value_table_scale, file=paste0(base_dir, "scripts/scaling/q50_B.csv"))
