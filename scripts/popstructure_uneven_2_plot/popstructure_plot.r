...
Nem2 <-  read.csv(paste0(base_dir, "scripts/popstructure_uneven_2_plot/Nem2.csv"))
Nem1 <-  read.csv(paste0(base_dir, "scripts/popstructure_uneven_2_plot/Nem1.csv"))
Nem01 <- read.csv(paste0(base_dir, "scripts/popstructure_uneven_2_plot/Nem01.csv"))
Nem05 <- read.csv(paste0(base_dir, "scripts/popstructure_uneven_2_plot/Nem05.csv"))
...
sfigure21 <- ggarrange(Nem2_plt, Nem1_plt, Nem05_plt, Nem01_plt,
                    labels = c("A", "B", "C", "D"),
                    font.label = list(size = 24, color = "black", face = "bold", family = NULL),
                    ncol = 2, nrow = 2,
                    common.legend = T, legend = "bottom")

ggsave("/nas/longleaf/home/adaigle/DFESelfing/figures_for_publication/sfigure21.svg", plot = sfigure21, width = 8.5, height = 10, dpi = 600)
