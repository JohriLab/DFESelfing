...
results_dir <- paste0(sim_outputs_dir, "scaling_q20_v2/")
source(paste0(base_dir, "scripts/calculate_pi_q20.r"))

figures_dir <- paste0(base_dir, "figures_for_publication/")
dfe_results_dir <- paste0(sim_outputs_dir, "scaling_q20/dfe_results/")
...
combo_plot_scale <- combo_plot_with_Badjusted %>% mutate(scale=20)
B_value_table_scale <- B_value_table %>% mutate(scale=20)
write.csv(combo_plot_scale, file=paste0(base_dir, "scripts/scaling/q20.csv"))
write.csv(B_value_table_scale, file=paste0(base_dir, "scripts/scaling/q20_B.csv"))
