...
tidy_summary_table <- tibble(
    fullpath = list.files(path = dirs, pattern = "^output..txt", full.names = T))#,
    #fullpath = paste0(dirs, "/", name)) #%>% 
  #filter(!grepl("g99_DFE2/output2|g99_DFE2/output5|g99_DFE3/output2|g99_DFE3/output5|g95_DFE3/output2|g95_DFE3/output2|g95_DFE3/output2|g95_DFE3/output2|", fullpath))
