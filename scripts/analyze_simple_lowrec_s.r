...
grapes_gammazero_raw_results <- grapes_gammazero_raw_results %>% 
  ...
  mutate(GammaZero.negGmean=GammaZero.negGmean/(2*B*5000))
...
dfealpha_raw_results_wtruth2 <- dfealpha_raw_results_wtruth %>% mutate(gamma=gamma/(B*5000*2))
...
figure <- ggplot(combo_plot_with_Badjusted, aes(x = generation, y = value, fill = factor(selfing, 
...
ggsave(paste0(figures_dir, "sfigure6_verynew.svg"), plot = figure, width = 8.5, height = 7.5, dpi = 300)
...
saveRDS(Badjusted_DFE1_99, "/nas/longleaf/home/adaigle/DFESelfing/scripts/summary_figures/DFE1_estimate_s_lowrec.rds")
saveRDS(Badjusted_DFE2_99, "/nas/longleaf/home/adaigle/DFESelfing/scripts/summary_figures/DFE2_estimate_s_lowrec.rds")
saveRDS(Badjusted_DFE3_99, "/nas/longleaf/home/adaigle/DFESelfing/scripts/summary_figures/DFE3_estimate_s_lowrec.rds")
