...
#  labs(x = "", y = expression(2 * N[e] * s[d]), fill = "", title = "") + 
#  scale_fill_manual(values=c("#404040", rep(c("#F8766D", "purple"),6))) + 
...
#                    ncol = 1, nrow = 2,
#                    common.legend = TRUE, legend = "bottom")
#ggsave("/nas/longleaf/home/adaigle/DFESelfing/figures_for_publication/sfigure01.svg", plot = sfigure01, width = 8.5, height = 9.5, dpi = 600)
#
...
#  ) 
#
#gammaorder_dom <- c("simulated gamma", "DFE-alpha", "GRAPES")
#
...
#                        values_from = "value")
#
#gammaorder_lowrec <- c("simulated gamma", "DFE-alpha", "GRAPES")
