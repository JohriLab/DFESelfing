...
slim -d d_Ncur=5000 -d d_selfing_prob=0.99 -d d_beta=0.5 -d d_gamma_del=50 -d d_f_pos=0.0 -d d_gamma_pos=0 -d d_dom_del=${dom_del} -d d_dom_pos=0.5 -d "d_repID='${repID}'" -d "d_folder='${folder}/eqm_selfing99_DFE2_hdel_0_75'" demo_DFE_gamma_selfing_Celegans.slim
