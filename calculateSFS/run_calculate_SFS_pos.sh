...
subfolder="eqm_selfing99_DFE3_pos"
...
#selected
python get_sfs_from_full_output_general_reps.py -inputFolder ${folder}/${subfolder} -inputFileExt ".txt" -outputFolder ${folder}/SFS -outputPrefix ${subfolder}_sel -mutnTypes m2,m4 -numGenomes 100
...
python get_fixed_class.py -inputFolder ${folder}/${subfolder} -inputFileExt ".fixed" -outputFolder ${folder}/SFS -outputPrefix ${subfolder}_sel -mutnTypes m2,m4 -numGenomes 100 -NAnc 5000
