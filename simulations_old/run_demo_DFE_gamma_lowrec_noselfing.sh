...
#SBATCH --time=1-06:00
#SBATCH -a 1-5%5
#SBATCH -o /home/pjohri1/LOGFILES/dfelowrec_%A_rep%a.out
#SBATCH -e /home/pjohri1/LOGFILES/dfelowrec_%A_rep%a.err
...
#eqm, no selfing, DFE1
#slim -d d_Ncur=5000 -d d_selfing_prob=0 -d d_beta=0.9 -d d_gamma_del=5 -d d_f_pos=0.0 -d d_gamma_pos=0 -d d_dom_del=0.5 -d d_dom_pos=0.5 -d "d_repID='${repID}'" -d "d_folder='${folder}/eqm_lowrec001_DFE1'" demo_DFE_gamma_selfing_Celegans_lowrec.slim

#eqm, no selfing, DFE2                                                          
slim -d d_Ncur=5000 -d d_selfing_prob=0 -d d_beta=0.5 -d d_gamma_del=50 -d d_f_pos=0.0 -d d_gamma_pos=0 -d d_dom_del=0.5 -d d_dom_pos=0.5 -d "d_repID='${repID}'" -d "d_folder='${folder}/eqm_lowrec001_DFE2'" demo_DFE_gamma_selfing_Celegans_lowrec.slim

#eqm, no selfing, DFE3                                                         
#slim -d d_Ncur=5000 -d d_selfing_prob=0 -d d_beta=0.3 -d d_gamma_del=1000 -d d_f_pos=0.0 -d d_gamma_pos=0 -d d_dom_del=0.5 -d d_dom_pos=0.5 -d "d_repID='${repID}'" -d "d_folder='${folder}/eqm_lowrec001_DFE3'" demo_DFE_gamma_selfing_Celegans_lowrec.slim
