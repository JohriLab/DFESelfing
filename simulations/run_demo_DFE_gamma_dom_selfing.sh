...
#SBATCH --time=1-06:00
#SBATCH -a 1-5%5
#SBATCH -o /home/pjohri1/LOGFILES/dfedomselfing_%A_rep%a.out
#SBATCH -e /home/pjohri1/LOGFILES/dfedomselfing_%A_rep%a.err
...
folder="/scratch/pjohri1/DFESelfing/gammaDFE_dom"
dom_del="0.25"

#eqm, no selfing, DFE1
slim -d d_Ncur=5000 -d d_selfing_prob=0 -d d_beta=0.9 -d d_gamma_del=5 -d d_f_pos=0.0 -d d_gamma_pos=0 -d d_dom_del=${dom_del} -d d_dom_pos=0.5 -d "d_repID='${repID}'" -d "d_folder='${folder}/eqm_selfing0_DFE1_hdel_0_25'" demo_DFE_gamma_selfing_Celegans.slim
