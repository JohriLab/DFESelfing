...
#eqm, no selfing, DFE1
slim -d d_Ncur=5000 -d d_selfing_prob=0.5 -d d_beta=0.9 -d d_gamma_del=5 -d d_f_pos=0.0 -d d_gamma_pos=0 -d d_dom_del=0.5 -d d_dom_pos=0.5 -d d_migration_rate=0.0102 -d d_subpopSize=984 -d "d_repID='${repID}'" -d "d_folder='${folder}/Nem10_eqm_selfing50_DFE1'" demo_DFE_gamma_selfing_Celegans_withstructure.slim
